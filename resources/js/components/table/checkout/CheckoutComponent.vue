            ...
            <div class="row">
                <div class="col-12 md:col-7">
                    <div class="mb-6 rounded-2xl shadow-xs bg-white">
                        <h3
                            class="capitalize font-medium p-4 border-b border-gray-100"
                        >
                            {{ $t("label.table") }}
                        </h3>
                        ...
                        <ul class="p-4 flex flex-col gap-5">
                            <li class="flex items-center gap-1.5">
                                <div class="custom-radio">
                                    ...
                                    />
                                    <span
                                        class="custom-radio-span border-gray-400"
                                    ></span>
                                </div>
                                <label
                                    for="cash"
                                    class="db-field-label text-heading"
                                    >{{ $t("label.cash_card") }}</label
                                >
                            </li>
                            <li class="flex items-center gap-1.5">
                                <div class="custom-radio">
                    ...
                    <div
                        v-if="paymentMethod === 'digitalPayment'"
                        class="mb-6 rounded-2xl shadow-xs bg-white"
                    >
                        <h3
                            class="capitalize font-medium p-4 border-b border-gray-100"
                        >
                ...
                <div class="col-12 md:col-5">
                    <div class="rounded-2xl shadow-xs bg-white">
                        <div class="p-4 border-b">
                            ...
                            <div class="pl-3">
                                ...
                                >
                                    ...
                                    <ul
                                        v-if="
                                            cart.item_extras.extras.length >
                                                0 || cart.instruction !== ''
                                        "
                        ...
                        <div class="p-4">
                            <div
                                class="rounded-xl mb-6 border border-[#EFF0F6]"
                            >
                                <ul
...
export default {
    ...
    methods: {
        ...
        orderSubmit: function () {
            ...
            this.checkoutProps.form.customer = this.customer;
